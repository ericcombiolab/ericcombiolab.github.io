...
- Towards Trustworthy Foundation Models under Imperfect Scenarios. Young Collaborative Research Grant, RGC/C2005-24Y (Co-PI, 4,006,800HKD; allocated 789,360HKD, 2025.7-2028.6).

- Improved Metabolic Network Reconstruction and Metabolite Profiles Prediction using Complete and Strain-Resolved Microbial Genomes. Young Collaborative Research Grant, RGC/C2004-23Y (PC, 4,494,061HKD, 2024.6-2027.5).

- Advancing clinical differentiation between constipation-predominant irritable bowel syndrome and functional constipation using machine learning models. Health and Medical Research Fund, 11221026 (PI, 487,800HKD, 2024.9-2027.8).

- Computational models for health management system using multi-source data, Guangdong-Hong Kong Technology Cooperation Funding Scheme, GHX/133/20SZ, (PI, 1,844,600HKD, 2022.9-2024.8).

- 基于长读长测序技术的宏基因组组装算法研究, BGI Open Fund, BGIRSZ20220014, (PI, 450,000RMB, 2023.1-2024.12).
